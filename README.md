...
**Analytics · AI Systems · Consulting**

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/benedictdaxellsantoso)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/bdsantoso168)
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:benedict.d.santoso@gmail.com)

---

I turn messy processes and ambiguous data into decisions that actually get made.

Not dashboards. Not reports. Decisions. The kind that move when someone reads them.

I build at the intersection of analytics, AI systems, and consulting — where the output isn't a model, it's a workflow that no longer needs a human to babysit it. Python and SQL are my tools. Structured thinking is the product.
...
`Python` `SQL` `Claude Code` `RAG` `LLM Systems` `Jupyter` `JavaScript` `Excel` `Salesforce`

---

*Graduating May 2026. Open to full-time roles in analytics, consulting, and AI-driven decision systems.*
